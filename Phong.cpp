// Phong.cpp : Ce fichier contient la fonction 'main'. L'exécution du programme commence et se termine à cet endroit.
//
...
int main(void){
	...
	Object3D* body = new Object3D("data/batman.obj");
	//body->ModelMatrix = glm::rotate(body->ModelMatrix, glm::radians(-90.0f), glm::vec3(1.0f, 0.0f, 0.0f));




	body->setShaders("StandardShading.vert", "phong.frag");
	...
	gizmo->setShaders("gizmo.vert", "gizmo.frag");
