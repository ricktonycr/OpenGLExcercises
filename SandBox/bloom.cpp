...
Bloom::Bloom(int w, int h, std::vector<Object3D*> * _objects) {
	...
	for (int i = 0; i < objects->size(); i++) {
		objects->at(i)->autoShadersForBloom();
	}
	...
	std::cout << "BLOOM" << glGetUniformLocation(programIDBlurX, "renderedTexture") << glGetUniformLocation(programIDBlurY, "renderedTexture") << std::endl;
